...
const Navbar = () => {
  return (
    <nav className="flex gap-5 h-[70px] bg-[#2ba331] items-center justify-between overflow-hidden w-full text-white px-2.5">
      <h1 className="text-3xl flex-3 nav-heading font-bold hover:invert-[1] transition duration-300 ease-in-out">Developer Saumya</h1>
      <ul className="flex flex-1 justify-around items-center text-2xl h-full nav-ul">
